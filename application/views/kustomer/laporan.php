...
<div class="container-fluid px-4">
    ...
    <li class="breadcrumb-item"><?php echo site_url('user') ?>">Dashboard</a></li>
        ...
        <div class="card mb-4">
            ...
            <div class="card mb-4">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('report/kustomerfull') ?>" target="_blank">
                    <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">External file Controller : Meyertakan report pada file berbeda dan diletakan di folder view</label>
            </div>
            <button type="submit" class="btn btn-warning">Cetak Laporan</button>
        </form>
    </div>
...
<div class="card mb-4">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url('report/kustomerkustom') ?>" target="_blank">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Custom Ekternal file Controller : Meyertakan report pada file berbeda dan diletakan di folder view berdasarkan fungsi</label>
            </div>
            <button type="submit" class="btn btn-warning">Cetak Laporan</button>
        </form>
    </div>
